...
const TodoView = () => {
    ...
    return <div className="todoList ">
      <table className="table-todo table table-info table-hover border border-dark shadow-lg rounded">
        ...
        <tbody className="body-table ">
          {currentList.map((todo) => {
            return <tr className="tr-table" key={todo.id} style={todo.completed ? decorationDone : {}}>
              ...
              <td id="td-actions"><button className="btn btn-primary" onClick={() => onEdit(todo)}>Editar</button></td>
